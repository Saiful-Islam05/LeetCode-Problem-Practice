...
#define endl '\n'
    ...
    node *deleteNode(node *currentNode, int value)
    {
        ...
        else if(value<currentNode->number) //value is less than nodes number, So got to left subtree.
        {
            currentNode->leftChild = deleteNode(currentNode->leftChild, value);
        }
        else if(value>currentNode->number) //value is greater than nodes number, So got to right subtree.
        {
